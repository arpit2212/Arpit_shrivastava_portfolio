        ...
        >
          ...
          >
            <motion.div
              ...
              className="relative w-full min-h-[520px] md:min-h-[450px] cursor-pointer"
              onClick={() => isMobile && setIsFlipped(!isFlipped)}
            >
              {/* Front Side: About Me Content */}
              <div 
                style={{ backfaceVisibility: "hidden" }}
                className="absolute inset-0 w-full h-full space-y-4 md:space-y-8 backdrop-blur-lg bg-white/5 p-8 md:p-8 rounded-2xl border border-white/10 shadow-2xl shadow-black/25 flex flex-col justify-center"
              >
              ...
              <div 
                ...
                className="absolute inset-0 w-full h-full backdrop-blur-lg bg-white/5 p-8 md:p-8 rounded-2xl border border-white/10 shadow-2xl shadow-black/25 flex flex-col justify-between"
              >
